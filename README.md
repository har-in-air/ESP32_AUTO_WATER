...
## Spreadsheet Log Update 
[Here is the PDF export of the Google Spreadsheet from fully-charged first update, to last successful update.](docs/Data_Logger%20-%20AutoWater.pdf)

The system ran without issues for 251 days starting with a fully charged 200mAHr single-cell LiPoly battery.
